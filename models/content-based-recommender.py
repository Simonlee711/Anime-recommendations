'''
###################################
### NOT OUR WORK. NOT OUR MODEL ###
###################################

# a Pre-exiting model of the recommendation system without the transformer. 
# Maybe we can use this to combine both transformer model with this simple one hot encoding model
